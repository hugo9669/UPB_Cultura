...
r.get("/group/:groupId", requireAuth, listMembersCtrl); // listar miembros de un grupo (legacy)
r.get("/groups/:groupId/members", requireAuth, listMembersCtrl); // listar miembros de un grupo (nuevo)
...
r.delete("/groups/:groupId/members/:userId", requireAuth, removeMemberCtrl); // remover miembro (nuevo)
